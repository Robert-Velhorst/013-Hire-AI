...
| Admin | source health, privacy/operating reviews, billing/compliance operations | Admin authorization is server-enforced; privileged queries stay disabled for non-admin users. |
