...
| Settings | autonomous-preparation policy and server-side data export | Export excludes document bytes, storage keys, and credentials. |
| Admin | source health, reviews, billing/compliance operations | Admin authorization is server-enforced. |
