...
| Full product localization | Partial | English/Dutch account persistence plus shared headers, Settings/privacy controls, saved-jobs, job-alerts, Team, and not-found translations exist; translate remaining workflow copy and complete native-speaker/accessibility review. |
