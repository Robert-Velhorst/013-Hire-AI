...
| Full product localization | Partial | English/Dutch account persistence plus shared headers, Settings/privacy controls, AI preference controls and scheduler summaries, Job Search, saved-jobs, job-alerts, Team, the complete user-authored Profile setup surface, Billing and success-fee controls, shared dialog accessibility names, and not-found translations exist. Employer/provider evidence remains verbatim by design. Define a safe policy for other backend-generated diagnostics, translate remaining workflows, and complete native-speaker/accessibility review. |
