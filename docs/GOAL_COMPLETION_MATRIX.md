...
| 059-069 state machines, invariants, safety screen, threat model, supply chain, CI/release | Partial | Lifecycle and fee state machines, constraints, Ubuntu/Windows CI, review gates, and an enforced high/critical dependency scan exist. Formal threat-model review and deployment approval remain. |
