...
| 028-030 privacy, web security, secrets | Partial | Authenticated metadata export and baseline headers added. Deletion/retention for legal and payment evidence remains operator/legal controlled. |
...
| 092-104 clone, verification, roadmap, provider cleanup, support, retention, migration, emergency stop | Partial | Commands and runbooks exist; fresh-clone, backup restore, legal retention, and real-provider cleanup await an environment and owner action. |
