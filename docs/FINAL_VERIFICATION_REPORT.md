...
| Unit and integration tests | `npm.cmd test -- --run` | Passed: 153 files, 783 tests |
...
- Retention/deletion policy, security/legal review, accessibility review, penetration testing, and a formal incident response exercise require operator decisions and external evidence.
