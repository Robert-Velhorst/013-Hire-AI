...
| Full regression | `npm.cmd test -- --run`: 159 files, 807 tests | Complete |
...
| Operating query efficiency | Migration 0036; 17 schema-aligned indexes; bounded privacy/deduplication reads; shared child-evidence and interview-preparation batches per ledger | Complete locally; production migration acceptance pending |
