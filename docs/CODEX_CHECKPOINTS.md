...
| Full regression | `npm.cmd test -- --run`: 159 files, 805 tests | Complete |
...
| Operating query efficiency | Migration 0036; 17 schema-aligned indexes; bounded privacy, evidence, duplicate-group, and offer-attribution reads | Complete locally; production migration acceptance pending |
