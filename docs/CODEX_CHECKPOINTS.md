...
| Operating query efficiency | Migration 0036; 17 schema-aligned indexes; bounded privacy/deduplication reads; three shared ownership-scoped child-evidence batches per ledger | Complete locally; production migration acceptance pending |
