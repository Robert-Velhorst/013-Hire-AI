...
| Full regression | `npm.cmd test -- --run`: 159 files, 809 tests | Complete |
...
| Operating query efficiency | Migration 0036; 17 schema-aligned indexes; bounded privacy/deduplication/admin-review reads; shared child evidence, offer attribution, and interview-preparation datasets per ledger | Complete locally; production migration acceptance pending |
