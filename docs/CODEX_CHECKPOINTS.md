...
| Operating query efficiency | Migration 0036; 17 schema-aligned indexes; bounded privacy, evidence, and duplicate-group reads | Complete locally; production migration acceptance pending |
