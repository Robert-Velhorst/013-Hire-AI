...
- Replaced English material-evidence display strings with structured resume, cover-letter, supported-skill, and salary evidence; salary expectations now preserve their recorded currency and use account-locale formatting instead of silently rendering every snapshot as USD.
