...
English and Dutch account-language selection now persists in MySQL and localizes shared navigation and account headers, saved jobs, job alerts, team governance, and not-found handling. Remaining workflow-page copy still requires translation plus native-speaker and accessibility review.
